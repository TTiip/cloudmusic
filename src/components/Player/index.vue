        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-center" >
              <i class="iconfont" :class="['iconfont', playIcon]" @click="togglePlaying"></i>
            </div>
            <div class="icon i-right" >
              <i class="iconfont icon-kuaijin" @click="next"></i>
            </div>
            <div class="icon i-right">
              <i class="iconfont icon-xiai"  @click="toggleFavorite(currentSong)" :class="getFavoriteIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click.stop="open">
        ...
        <div class="control" @click.stop="togglePlaying">
          <progress-circle :radius="radius" :percent="percent">
            ...
            <i style="position: absolute;top: 8px;left: 8px;font-size: 16px;" class="iconfont" :class="miniIcon"></i>
          </progress-circle>
        </div>
        <div class="control" @click.stop="showPlaylist">
          <i style="font-size: 23px;" class="iconfont icon-liebiao"></i>
        </div>
      </div>
    </transition>
...
export default {
  ...
  computed: {
    ...
    miniIcon () {
      return this.playing ? 'icon-zantingtingzhi' : 'icon-la-'
    },
    playIcon () {
